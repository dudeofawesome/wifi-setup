...
module.exports = {
    ...
    generatePassword: function generatePassword(length, requirements, specialLists) {
    ...
    backupFile: function backupFile(path, modifier) {
        if (!modifier) {
            modifier = function modifier(path) {
                return path += '.back';
            };
        }
